...
This guide explains how to use Hazelcast in the Istio environment. You'll learn how to set up Hazelcast cluster and use it with Hazelcast client. Then, you can also see how to deploy an application with embedded Hazelcast.
