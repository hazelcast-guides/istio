...
This guide contains basic Spring Boot microservices with both Hazelcast Embedded and Hazelcast Client-Server. Those microservices demonstarates how Hazelcast can be used in the Istio environments. The guide mainly focuses on how to run Hazelcast with Istio. It does not explain what service meshes are and how Istio works.
...
=== Istio 1.6.6
This code sample has been tested against Istio 1.6.6
...
data plane version: 1.6.6 (3 proxies)
----
****
